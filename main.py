"""
# MAML
python3 main.py --datasource SineLine --ml-algorithm MAML --first-order --network-architecture FcNet --no-batchnorm --num-ways 1 --k-shot 5 --inner-lr 0.001 --meta-lr 0.001 --num-epochs 50 --resume-epoch 0 --train
...
# VAMPIRE2
python3 main.py --datasource SineLine --ml-algorithm vampire2 --num-models 4 --first-order --network-architecture FcNet --no-batchnorm --num-ways 1 --k-shot 5 --inner-lr 0.001 --meta-lr 0.001 --num-epochs 50 --resume-epoch 0 --train

python3 main.py --datasource miniImageNet --ml-algorithm vampire2 --num-models 2 --first-order --network-architecture CNN --no-batchnorm --num-ways 5 --no-strided --num-epochs 50 --resume-epoch 0 --train

# ABML
python3 main.py --datasource SineLine --ml-algorithm abml --num-models 4 --first-order --network-architecture FcNet --no-batchnorm --num-ways 1 --k-shot 5 --inner-lr 0.001 --meta-lr 0.001 --num-epochs 50 --resume-epoch 0 --train

python3 main.py --datasource miniImageNet --ml-algorithm abml --num-models 2 --first-order --network-architecture CNN --no-batchnorm --num-ways 5 --no-strided --num-epochs 50 --resume-epoch 0 --train

# PLATIPUS
python3 main.py --datasource SineLine --ml-algorithm platipus --num-models 4 --first-order --network-architecture FcNet --no-batchnorm --num-ways 1 --k-shot 5 --inner-lr 0.001 --meta-lr 0.001 --num-epochs 50 --resume-epoch 0 --train

python3 main.py --datasource miniImageNet --ml-algorithm platipus --num-models 2 --first-order --network-architecture CNN --no-batchnorm --num-ways 5 --no-strided --num-epochs 50 --resume-epoch=0 --train

# BMAML
python3 main.py --datasource SineLine --ml-algorithm bmaml --num-models 4 --first-order --network-architecture FcNet --no-batchnorm --num-ways 1 --k-shot 5 --inner-lr 0.001 --meta-lr 0.001 --num-epochs 50 --resume-epoch 0 --train

python3 main.py --datasource miniImageNet --ml-algorithm bmaml --num-models 2 --first-order --network-architecture CNN --no-batchnorm --no-strided --num-ways 5 --num-epochs 50 --resume-epoch 0 --train

# PROTONET
python3 main.py --datasource miniImageNet --ml-algorithm protonet --network-architecture CNN --no-batchnorm --num-ways 5 --no-strided --num-epochs 50 --resume-epoch 0 --train

# GPML
python3 main.py --datasource miniImageNet --img-size 84 --img-size 84 --ml-algorithm gpml --network-architecture CNN --no-batchnorm --no-strided --num-ways 5 --k-shot 1 --num-models 1 --minibatch 10 --inner-lr 0.01 --meta-lr 0.001 --num-epochs 50 --resume-epoch 0 --train
"""
import torch
...
parser.add_argument('--datasource', action='append', help='List of datasets: SineLine for regression, and omniglot, miniImageNet, tieredImageNet, ImageNet for classification')
...
parser.add_argument('--network-architecture', type=str, default='CNN', help='The base model used, including CNN, ResNet12, ResNet18, WRN-28-10 defined in CommonModels')
...
parser.add_argument('--num-episodes', type=int, default=50, help='Number of episodes used in testing')
